...
class HuxCrossoverTest {
  private HuxCrossover huxCrossover;

  @BeforeEach
  void setUp() {
    huxCrossover = new HuxCrossover(new GACrossoverConf(GACrossoverType.HUX, 1));
  }
  ...
  void crossover() throws AExOpDCSException {
    ...
    head1.setFromString("MIC_S_T_ptt");
    head2.setFromString("TIC_T_ptt");

    List<AHeadEntity> children = huxCrossover.makeCrossover(head1, head2);
