...
public class EvaluateSubset extends AttributeSelection implements IEvaluateSubset {
  ...
  private PopulationInstances handleException(
      String msg, Exception ex, PopulationInstances inst, long startTime) throws AExOpDCSException {
    log.error(
  ...
  private PopulationInstances filterSelectedAttributes(
      PopulationInstances inst, long startTime, int[] selectedAttributes, double meritValue)
